...
import static my_spring.utils.AnnotationsUtils.hasAnnotationOrHasAnnotatedMethod;
...
public class BenchmarkInvocationHandler<T> implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        if (hasAnnotationOrHasAnnotatedMethod(obj.getClass(), Benchmark.class, method)) {
